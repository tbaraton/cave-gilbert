          ...
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: 8 }}>
            ...
            <button onClick={() => {
              ...
              const lignesFuts = (r.reservation_futs || []).map((rf: any) =>
                `<tr><td style="padding:10px 12px;border-bottom:0.5px solid rgba(255,255,255,0.06);font-size:13px;color:#e8e0d5">Location fût ${rf.fut?.nom_cuvee} ${rf.fut?.contenance_litres}L</td><td style="padding:10px 12px;border-bottom:0.5px solid rgba(255,255,255,0.06);text-align:center;font-size:13px;color:#e8e0d5">${rf.quantite}</td><td style="padding:10px 12px;border-bottom:0.5px solid rgba(255,255,255,0.06);text-align:right;font-size:13px;color:#c9a96e">${fmt(rf.prix_unitaire_ttc * rf.quantite)}</td></tr>`
              ).join('')
              const lignesTireuses = (r.reservation_tireuses || []).map((rt: any) =>
                `<tr><td style="padding:10px 12px;border-bottom:0.5px solid rgba(255,255,255,0.06);font-size:13px;color:#e8e0d5">Tireuse : ${rt.tireuse?.nom} (${rt.tireuse?.modele})</td><td style="padding:10px 12px;border-bottom:0.5px solid rgba(255,255,255,0.06);text-align:center;font-size:13px;color:#e8e0d5">1</td><td style="padding:10px 12px;border-bottom:0.5px solid rgba(255,255,255,0.06);text-align:right;font-size:13px;color:#c9a96e">incluse</td></tr>`
              ).join('')
              const html = `<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><title>Bon de confirmation ${r.numero}</title><style>*{margin:0;padding:0;box-sizing:border-box}body{font-family:Arial,sans-serif;background:#0d0a08;color:#e8e0d5;max-width:800px;margin:0 auto;padding:40px 32px;-webkit-print-color-adjust:exact;print-color-adjust:exact}@media print{body{background:#0d0a08!important}*{-webkit-print-color-adjust:exact!important}}.header{display:flex;justify-content:space-between;margin-bottom:32px;padding-bottom:20px;border-bottom:1px solid rgba(201,169,110,0.3)}.cave-name{font-size:20px;color:#c9a96e;font-family:Georgia,serif;letter-spacing:2px}.cave-info{font-size:11px;color:rgba(232,224,213,0.4);line-height:2;margin-top:6px}.doc-title{font-size:11px;letter-spacing:4px;text-transform:uppercase;color:rgba(201,169,110,0.6);margin-bottom:6px;text-align:right}.doc-numero{font-size:22px;color:#c9a96e;font-family:Georgia,serif;text-align:right}.section{background:rgba(255,255,255,0.03);border:0.5px solid rgba(255,255,255,0.08);border-radius:8px;padding:16px 20px;margin-bottom:16px}.section-title{font-size:10px;letter-spacing:2px;text-transform:uppercase;color:rgba(201,169,110,0.6);margin-bottom:10px}table{width:100%;border-collapse:collapse}th{padding:8px 12px;text-align:left;font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:rgba(201,169,110,0.5);font-weight:400;border-bottom:0.5px solid rgba(201,169,110,0.2)}.total-row{display:flex;justify-content:space-between;padding:10px 12px;font-size:18px;font-family:Georgia,serif;color:#c9a96e;font-weight:700;background:rgba(201,169,110,0.06);border-radius:6px;margin-top:12px}.sig-zone{display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-top:32px}.sig-box{border-top:0.5px solid rgba(201,169,110,0.3);padding-top:10px}.sig-label{font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:rgba(201,169,110,0.5);margin-bottom:32px}.footer{margin-top:28px;padding-top:14px;border-top:0.5px solid rgba(255,255,255,0.06);font-size:10px;color:rgba(232,224,213,0.2);line-height:2}</style></head><body>
              <div class="header"><div><div class="cave-name">Cave de Gilbert</div><div class="cave-info">Avenue Jean Colomb — 69280 Marcy l'Étoile<br>04 22 91 41 09 · contact@cavedegilbert.fr</div></div><div><div class="doc-title">Bon de confirmation</div><div class="doc-numero">${r.numero}</div><div style="font-size:12px;color:rgba(232,224,213,0.4);text-align:right;margin-top:4px">${new Date().toLocaleDateString('fr-FR')}</div></div></div>
              <div class="section"><div class="section-title">Client</div><div style="font-size:17px;color:#f0e8d8;font-family:Georgia,serif">${clientN}</div>${r.customer?.telephone ? `<div style="font-size:13px;color:rgba(232,224,213,0.5);margin-top:4px">📞 ${r.customer.telephone}</div>` : ''}</div>
              <div class="section"><div class="section-title">Période</div><div style="display:grid;grid-template-columns:1fr 1fr;gap:16px"><div><div style="font-size:10px;color:rgba(232,224,213,0.4);letter-spacing:1px;margin-bottom:4px">DÉPART</div><div style="font-size:15px;color:#f0e8d8">${new Date(r.date_debut + 'T12:00:00').toLocaleDateString('fr-FR', {weekday:'long',day:'2-digit',month:'long',year:'numeric'})}</div></div><div><div style="font-size:10px;color:rgba(232,224,213,0.4);letter-spacing:1px;margin-bottom:4px">RETOUR</div><div style="font-size:15px;color:#f0e8d8">${new Date(r.date_fin + 'T12:00:00').toLocaleDateString('fr-FR', {weekday:'long',day:'2-digit',month:'long',year:'numeric'})}</div></div></div></div>
              <div class="section"><div class="section-title">Détail de la location</div><table><thead><tr><th>Désignation</th><th style="text-align:center">Qté</th><th style="text-align:right">Total TTC</th></tr></thead><tbody>${lignesTireuses}${lignesFuts}</tbody></table><div class="total-row"><span>Total TTC</span><span>${fmt(r.total_ttc || 0)}</span></div>${r.acompte_ttc ? `<div style="font-size:13px;color:#6ec96e;margin-top:8px;padding:8px 12px;background:rgba(110,201,110,0.08);border-radius:6px">✓ Acompte versé : ${fmt(r.acompte_ttc)} (${r.acompte_mode})<br><span style="color:rgba(232,224,213,0.5)">Solde à régler au retour : ${fmt((r.total_ttc||0) - r.acompte_ttc)}</span></div>` : ''}<div style="font-size:12px;color:rgba(232,224,213,0.4);margin-top:8px;padding:8px 12px;background:rgba(255,255,255,0.03);border-radius:6px">Caution tireuse : <strong style="color:#f0e8d8">${fmt(r.caution_tireuse_ttc||0)}</strong></div></div>
              <div class="sig-zone"><div class="sig-box"><div class="sig-label">Signature client — Bon pour accord</div></div><div class="sig-box"><div class="sig-label">Cave de Gilbert</div><div style="font-family:Georgia,serif;font-size:18px;color:#c9a96e">Cave de Gilbert</div></div></div>
            ...
            {['confirmée','en_cours','terminée'].includes(r.statut) && (
              <button onClick={() => {
                ...
                const itemsHtml = inventaire.map(i => `<div style="display:flex;align-items:flex-start;gap:10px;padding:6px 0;border-bottom:0.5px solid rgba(255,255,255,0.04);font-size:14px;color:#e8e0d5"><span style="color:#c9a96e;font-size:16px;flex-shrink:0">☑</span><span>${i}</span></div>`).join('')
                const futsHtml = (r.reservation_futs||[]).map((rf: any) => `<div style="display:flex;align-items:center;gap:10px;padding:6px 0;border-bottom:0.5px solid rgba(255,255,255,0.04);font-size:14px;color:#e8e0d5"><span style="color:#c9a96e;font-size:16px">☑</span><span>${rf.quantite} × ${rf.fut?.nom_cuvee} ${rf.fut?.contenance_litres}L</span></div>`).join('')
                const tirsHtml = (r.reservation_tireuses||[]).map((rt: any) => `<div style="display:flex;align-items:center;gap:10px;padding:6px 0;border-bottom:0.5px solid rgba(255,255,255,0.04);font-size:14px;color:#e8e0d5"><span style="color:#c9a96e;font-size:16px">☑</span><span>Tireuse : ${rt.tireuse?.nom} (${rt.tireuse?.modele})</span></div>`).join('')
                const html = `<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><title>Bon de livraison ${r.numero}</title><style>*{margin:0;padding:0;box-sizing:border-box}body{font-family:Arial,sans-serif;background:#0d0a08;color:#e8e0d5;max-width:800px;margin:0 auto;padding:40px 32px;-webkit-print-color-adjust:exact;print-color-adjust:exact}@media print{body{background:#0d0a08!important}*{-webkit-print-color-adjust:exact!important}}.header{display:flex;justify-content:space-between;margin-bottom:32px;padding-bottom:20px;border-bottom:1px solid rgba(201,169,110,0.3)}.cave-name{font-size:20px;color:#c9a96e;font-family:Georgia,serif;letter-spacing:2px}.cave-info{font-size:11px;color:rgba(232,224,213,0.4);line-height:2;margin-top:6px}.section{background:rgba(255,255,255,0.03);border:0.5px solid rgba(255,255,255,0.08);border-radius:8px;padding:16px 20px;margin-bottom:16px}.section-title{font-size:10px;letter-spacing:2px;text-transform:uppercase;color:rgba(201,169,110,0.6);margin-bottom:10px}.warning{background:rgba(201,110,110,0.12);border:1px solid rgba(201,110,110,0.4);border-radius:8px;padding:14px 18px;margin:16px 0}.sig-zone{display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-top:32px}.sig-box{border-top:0.5px solid rgba(201,169,110,0.3);padding-top:10px}.footer{margin-top:28px;padding-top:14px;border-top:0.5px solid rgba(255,255,255,0.06);font-size:10px;color:rgba(232,224,213,0.2);line-height:2}</style></head><body>
                <div class="header"><div><div class="cave-name">Cave de Gilbert</div><div class="cave-info">Avenue Jean Colomb — 69280 Marcy l'Étoile<br>04 22 91 41 09 · contact@cavedegilbert.fr</div></div><div><div style="font-size:11px;letter-spacing:4px;text-transform:uppercase;color:rgba(201,169,110,0.6);margin-bottom:6px;text-align:right">Bon de livraison</div><div style="font-size:22px;color:#c9a96e;font-family:Georgia,serif;text-align:right">${r.numero}</div><div style="font-size:12px;color:rgba(232,224,213,0.4);text-align:right;margin-top:4px">${new Date().toLocaleDateString('fr-FR')}</div></div></div>
                <div class="section"><div class="section-title">Client</div><div style="font-size:17px;color:#f0e8d8;font-family:Georgia,serif">${clientN}</div>${r.customer?.telephone ? `<div style="font-size:13px;color:rgba(232,224,213,0.5);margin-top:4px">📞 ${r.customer.telephone}</div>` : ''}</div>
                <div class="section"><div class="section-title">Période</div><div style="display:grid;grid-template-columns:1fr 1fr;gap:16px"><div><div style="font-size:10px;color:rgba(232,224,213,0.4);margin-bottom:4px">DÉPART</div><div style="font-size:15px;color:#f0e8d8">${new Date(r.date_debut + 'T12:00:00').toLocaleDateString('fr-FR', {weekday:'long',day:'2-digit',month:'long'})}</div></div><div><div style="font-size:10px;color:rgba(232,224,213,0.4);margin-bottom:4px">RETOUR</div><div style="font-size:15px;color:#f0e8d8">${new Date(r.date_fin + 'T12:00:00').toLocaleDateString('fr-FR', {weekday:'long',day:'2-digit',month:'long'})}</div></div></div></div>
                ...
                <div class="sig-zone"><div class="sig-box"><div style="font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:rgba(201,169,110,0.5);margin-bottom:32px">Signature client — Bon pour accord</div></div><div class="sig-box"><div style="font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:rgba(201,169,110,0.5);margin-bottom:8px">Cave de Gilbert</div><div style="font-family:Georgia,serif;font-size:18px;color:#c9a96e">Cave de Gilbert</div></div></div>
                <div class="footer">Cave de Gilbert · Avenue Jean Colomb, 69280 Marcy l'Étoile · contact@cavedegilbert.fr · 04 22 91 41 09</div></body></html>`
                const w = window.open('', '_blank'); if (w) { w.document.write(html); w.document.close(); w.print() }
            ...
            {r.statut === 'terminée' && (
              <button onClick={() => {
                ...
                const lignesHtml = (r.reservation_futs||[]).map((rf: any) => {
                  ...
                  return `<tr><td style="padding:10px 12px;border-bottom:0.5px solid rgba(255,255,255,0.06);font-size:13px;color:#e8e0d5">Location fût ${rf.fut?.nom_cuvee} ${rf.fut?.contenance_litres}L<br><span style="font-size:10px;color:rgba(232,224,213,0.4)">${new Date(r.date_debut+'T12:00:00').toLocaleDateString('fr-FR')} au ${new Date(r.date_fin+'T12:00:00').toLocaleDateString('fr-FR')}</span></td><td style="padding:10px 12px;border-bottom:0.5px solid rgba(255,255,255,0.06);text-align:center;font-size:13px;color:#e8e0d5">${rf.quantite}</td><td style="padding:10px 12px;border-bottom:0.5px solid rgba(255,255,255,0.06);text-align:right;font-size:13px;color:rgba(232,224,213,0.6)">${prixHT.toFixed(2)} €</td><td style="padding:10px 12px;border-bottom:0.5px solid rgba(255,255,255,0.06);text-align:right;font-size:13px;color:#c9a96e">${(prixTTC*rf.quantite).toFixed(2)} €</td></tr>`
                }).join('')
                const totalTTC = r.total_ttc || 0
                const totalHT = totalTTC / (1 + tvaRate)
                const tva = totalTTC - totalHT
                const html = `<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><title>Facture ${numeroFac}</title><style>*{margin:0;padding:0;box-sizing:border-box}body{font-family:Arial,sans-serif;background:#0d0a08;color:#e8e0d5;max-width:800px;margin:0 auto;padding:40px 32px;-webkit-print-color-adjust:exact;print-color-adjust:exact}@media print{body{background:#0d0a08!important}*{-webkit-print-color-adjust:exact!important}}.header{display:flex;justify-content:space-between;margin-bottom:32px;padding-bottom:20px;border-bottom:1px solid rgba(201,169,110,0.3)}.cave-name{font-size:20px;color:#c9a96e;font-family:Georgia,serif;letter-spacing:2px}.cave-info{font-size:11px;color:rgba(232,224,213,0.4);line-height:2;margin-top:6px}.client-box{background:rgba(255,255,255,0.03);border-left:3px solid rgba(201,169,110,0.4);padding:12px 18px;margin-bottom:24px;font-size:13px;color:rgba(232,224,213,0.7);border-radius:0 6px 6px 0}table{width:100%;border-collapse:collapse}thead th{padding:8px 12px;text-align:left;font-size:9px;letter-spacing:2px;text-transform:uppercase;color:rgba(201,169,110,0.5);font-weight:400;border-bottom:1px solid rgba(201,169,110,0.3)}.totaux{border-top:1px solid rgba(201,169,110,0.2);margin-top:8px}.total-line{display:flex;justify-content:space-between;padding:8px 12px;font-size:13px;color:rgba(232,224,213,0.5)}.total-grand{display:flex;justify-content:space-between;padding:14px;background:rgba(201,169,110,0.08);border:0.5px solid rgba(201,169,110,0.2);border-radius:6px;margin-top:10px;font-size:20px;font-weight:700;color:#c9a96e;font-family:Georgia,serif}.footer{margin-top:32px;padding-top:14px;border-top:0.5px solid rgba(255,255,255,0.06);font-size:10px;color:rgba(232,224,213,0.2);line-height:2}</style></head><body>
                <div class="header"><div><div class="cave-name">Cave de Gilbert</div><div class="cave-info">Avenue Jean Colomb — 69280 Marcy l'Étoile<br>04 22 91 41 09 · contact@cavedegilbert.fr</div></div><div><div style="font-size:11px;letter-spacing:4px;text-transform:uppercase;color:rgba(201,169,110,0.6);margin-bottom:6px;text-align:right">Facture</div><div style="font-size:22px;color:#c9a96e;font-family:Georgia,serif;text-align:right">${numeroFac}</div><div style="font-size:12px;color:rgba(232,224,213,0.4);text-align:right;margin-top:4px">${new Date().toLocaleDateString('fr-FR')}</div></div></div>
                <div class="client-box"><strong style="color:#c9a96e">Client :</strong> ${clientN}${r.customer?.telephone ? ` · 📞 ${r.customer.telephone}` : ''}${r.customer?.email ? `<br>${r.customer.email}` : ''}</div>
